...
class HomeViewController: UIViewController {
    ...
    )
    {
        ...
        self.tracks = tracks
        // New Realeases Album CollectionView Model
        ...
        // FeaturedPlaylist CollectionView Model
        ...
        // RecommendedTracks CollectionView Model
...
extension HomeViewController : UICollectionViewDelegate,UICollectionViewDataSource
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .newReleases(let viewModels):
            ...
            cell.contentView.backgroundColor = UIColor(white: 0.11, alpha: 1)
            return cell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case .featuredPlaylists:
            ...
            navigationController?.pushViewController(vc, animated: true)
            break
        case.newReleases: // go to albumViewController
